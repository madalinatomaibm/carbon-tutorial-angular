...
function ComboBox_label_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, ComboBox_label_1_2_Template, 1, 1, undefined, 15);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function ComboBox_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ComboBox_div_5_Template_button_click_3_listener() { ɵngcc0.ɵɵrestoreView(_r16); const ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.clearSelected(); })("blur", function ComboBox_div_5_Template_button_blur_3_listener() { ɵngcc0.ɵɵrestoreView(_r16); const ctx_r17 = ɵngcc0.ɵɵnextContext(); return ctx_r17.onBlur(); })("keydown.enter", function ComboBox_div_5_Template_button_keydown_enter_3_listener() { ɵngcc0.ɵɵrestoreView(_r16); const ctx_r18 = ɵngcc0.ɵɵnextContext(); return ctx_r18.clearSelected(); });
...
function ComboBox_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keyup.enter", function ComboBox_div_10_Template_div_keyup_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r19 = ɵngcc0.ɵɵnextContext(); return ctx_r19.clearInput($event); })("click", function ComboBox_div_10_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r21 = ɵngcc0.ɵɵnextContext(); return ctx_r21.clearInput($event); })("blur", function ComboBox_div_10_Template_div_blur_0_listener() { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r22 = ɵngcc0.ɵɵnextContext(); return ctx_r22.onBlur(); });
    ɵngcc0.ɵɵnamespaceSVG();
...
function ComboBox_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, ComboBox_div_16_2_Template, 1, 1, undefined, 15);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r9 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, ctx_r9.disabled));
    ɵngcc0.ɵɵadvance(1);
...
function ComboBox_div_17_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, ComboBox_div_17_2_Template, 1, 1, undefined, 15);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function ComboBox_div_18_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, ComboBox_div_18_2_Template, 1, 1, undefined, 15);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
const _c5 = function (a0, a1, a2, a3, a4, a5, a6) { return { "bx--multi-select bx--multi-select--filterable": a0, "bx--list-box--light": a1, "bx--list-box--expanded": a2, "bx--list-box--sm": a3, "bx--list-box--lg": a4, "bx--list-box--disabled": a5, "bx--combo-box--warning bx--list-box--warning": a6 }; };
const _c6 = function (a0) { return { "bx--text-input--empty": a0 }; };
const _c7 = function (a0) { return { "bx--list-box__menu-icon--open": a0 }; };
const _c8 = function (a0) { return { "bx--list-box--up": a0 }; };
const _c9 = ["*"];
class ComboBox {
    /**
...
ComboBox.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: ComboBox, selectors: [["ibm-combo-box"]], contentQueries: function ComboBox_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ]), ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c9, decls: 19, vars: 38, consts: [[1, "bx--list-box__wrapper"], ["class", "bx--label", 3, "for", "ngClass", 4, "ngIf"], [1, "bx--list-box", "bx--combo-box", 3, "ngClass"], ["listbox", ""], [1, "bx--list-box__field", 3, "click", "blur"], ["class", "bx--tag bx--tag--filter bx--tag--high-contrast", 4, "ngIf"], ["type", "text", "role", "combobox", "tabindex", "0", "aria-haspopup", "listbox", "aria-haspopup", "true", 1, "bx--text-input", 3, "disabled", "value", "ngClass", "id", "placeholder", "input", "blur", "keydown.enter"], ["input", ""], ["ibmIcon", "warning--filled", "size", "16", "class", "bx--list-box__invalid-icon", 4, "ngIf"], ["ibmIcon", "warning--alt--filled", "size", "16", "class", "bx--list-box__invalid-icon bx--list-box__invalid-icon--warning", 4, "ngIf"], ["role", "button", "class", "bx--list-box__selection", "tabindex", "0", 3, "title", "keyup.enter", "click", "blur", 4, "ngIf"], ["type", "button", "role", "button", 1, "bx--list-box__menu-icon", 3, "title", "ngClass"], ["ibmIcon", "chevron--down", "size", "16"], [3, "ngClass"], ["dropdownMenu", ""], [4, "ngIf"], ["class", "bx--form__helper-text", 3, "ngClass", 4, "ngIf"], ["class", "bx--form-requirement", 4, "ngIf"], [1, "bx--label", 3, "for", "ngClass"], [3, "ngTemplateOutlet"], [1, "bx--tag", "bx--tag--filter", "bx--tag--high-contrast"], [1, "bx--tag__label"], ["type", "button", "tabindex", "0", 1, "bx--tag__close-icon", 3, "title", "click", "blur", "keydown.enter"], ["focusable", "false", "preserveAspectRatio", "xMidYMid meet", "role", "img", "xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "16", "viewBox", "0 0 16 16", "aria-hidden", "true", 2, "will-change", "transform"], ["d", "M12 4.7l-.7-.7L8 7.3 4.7 4l-.7.7L7.3 8 4 11.3l.7.7L8 8.7l3.3 3.3.7-.7L8.7 8z"], ["ibmIcon", "warning--filled", "size", "16", 1, "bx--list-box__invalid-icon"], ["ibmIcon", "warning--alt--filled", "size", "16", 1, "bx--list-box__invalid-icon", "bx--list-box__invalid-icon--warning"], ["role", "button", "tabindex", "0", 1, "bx--list-box__selection", 3, "title", "keyup.enter", "click", "blur"], ["ibmIcon", "close", "size", "16"], [1, "bx--form__helper-text", 3, "ngClass"], [1, "bx--form-requirement"]], template: function ComboBox_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(5, ComboBox_div_5_Template, 6, 3, "div", 5);
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction7(24, _c5, ctx.type === "multi", ctx.theme === "light", ctx.open, ctx.size === "sm", ctx.size === "xl", ctx.disabled, ctx.warn));
        ɵngcc0.ɵɵattribute("data-invalid", ctx.invalid ? true : null);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("ngIf", ctx.type === "multi" && ctx.pills.length > 0);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("disabled", ctx.disabled)("value", ctx.selectedValue)("ngClass", ɵngcc0.ɵɵpureFunction1(32, _c6, !ctx.showClearButton))("id", ctx.id)("placeholder", ctx.placeholder);
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("title", ctx.open ? ctx.closeMenuAria : ctx.openMenuAria)("ngClass", ɵngcc0.ɵɵpureFunction1(34, _c7, ctx.open));
        ɵngcc0.ɵɵattribute("aria-label", ctx.open ? ctx.closeMenuAria : ctx.openMenuAria);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(36, _c8, ctx.dropUp !== null && ctx.dropUp !== undefined ? ctx.dropUp : ctx._dropUp));
        ɵngcc0.ɵɵadvance(2);
...
ComboBoxModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [DropdownService], imports: [[
            CommonModule,
            DropdownModule,
            I18nModule,
            UtilsModule,
